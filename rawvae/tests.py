...
def init_test_audio(workdir, test_audio, my_test_audio, sampling_rate, segment_length, hop_length=128):
  ...
  # Create a dataloader for test dataset with proper hop_size for overlapping segments
  test_dataset = TestDataset(test_dataset_audio, segment_length=segment_length, sampling_rate=sampling_rate, hop_size=hop_length, transform=ToTensor())
